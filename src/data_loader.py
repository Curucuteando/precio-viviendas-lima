"""
Modulo para generar datos  sinteticos de viviendas en Lima

Este archivo simula un peque;o dataset para practicar GitHub,
GitHub Actions y organizacion de proyectos de Data Science
"""
import numpy as np
import pandas as pd
